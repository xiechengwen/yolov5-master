...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5x_cell.yaml', help='model/yolov5x_cell.yaml')
    parser.add_argument('--data', type=str, default='data/Cell.yaml', help='dataset.yaml path')
